...
class KNearestNeighbor:
    ...
    def compute_distances_no_loops(self, X):
        ...
        dists = np.sqrt(X2 + X_train2 - 2 * cross_term)
        # *****END OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
        return dists
    ...
    def predict_labels(self, dists, k=1):
        ...
        for i in range(num_test):
            ...
            class_values, class_frequences = np.unique(closest_y, return_counts=True)
            final_label = class_values[np.argmax(class_frequences)]
